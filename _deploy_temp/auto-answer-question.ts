...
serve(async (req) => {
  ...
  try {
    ...
    // IMPORTANT: Do NOT email the student here. The AI answer is provisional.
    // A human (mentor or admin) reviews it in the Q&A tab and clicks "Approve" or "Edit + Send",
    // at which point send-question-answered fires. This prevents wrong AI answers from being blast-emailed.
