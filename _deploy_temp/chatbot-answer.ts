...
## Payment methods
- We accept **ACH bank transfer** and **mailed check / bank draft** payable to MD Scholars LLC.
- Full payment details (bank routing and account, mail-in address, memo instructions) are sent privately in the acceptance email so we can match payments to enrollments — for security we don't quote them in chat.
- Credit card / Apple Pay / Google Pay — coming soon (not available yet).
- Billing questions before applying: email support@mdscholars.com with subject "Billing".
